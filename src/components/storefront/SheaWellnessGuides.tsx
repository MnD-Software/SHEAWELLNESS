...
const guides: Guide[] = [
  {
    ...
    intro: "If your skin feels dry, rough, flaky, tight, or itchy, Shea Wellness's natural skincare range is designed to cleanse gently, replenish lost moisture, and restore your skin's protective barrier. Our products work together to hydrate, nourish, and soften the skin without relying on harsh chemicals.",
    ...
    products: [
      ...
      },
      {
        ...
        image: "/assets/website-edits/massage-oils.jpg",
    ...
    results: ["Softer and smoother skin", "Better hydration throughout the day", "Less flaking and roughness", "More comfort with reduced tightness and dryness", "Healthier-looking skin with a natural glow"],
    closing: "The Shea Wellness Promise: consistent, nature-led care for deeply nourished skin."
  },
  {
    id: "sensitive-skin",
    title: "Sensitive skin solution",
    intro: "Sensitive skin requires gentle, nourishing care that protects the skin's natural barrier without causing irritation. Whether your skin is easily irritated by weather, harsh soaps, fragrances, or environmental factors, this holistic routine helps calm, hydrate, and restore delicate skin using naturally derived ingredients.",
    ...
    results: ["Better hydration", "Softer and smoother skin", "More comfort and less dryness", "Better support for a healthy skin barrier", "Naturally radiant, healthy-looking skin"],
    closing: "Sensitive skin deserves gentle, intentional care. Shea butter and carefully selected botanical oils help skin feel calm, comfortable, healthy, and beautifully cared for—every day."
  },
  {
    id: "face-care",
    ...
    suitableFor: ["Dry skin", "Normal skin", "Combination skin", "Mature skin", "Dull-looking skin", "Dehydrated skin", "Sensitive skin after patch testing"],
    results: ["Cleaner and refreshed skin", "Better hydration", "Softer and smoother texture", "A more supple and comfortable feel", "A naturally radiant, healthy-looking glow", "Better support for a healthy moisture barrier"],
    closing: "Healthy skin begins with simple, effective care inspired by nature. Use this three-step routine consistently every morning and evening."
  },
  {
    id: "body-glow",
    ...
    results: ["Softer and smoother skin", "Better hydration", "A fresh and revitalized feel", "More supple and comfortable skin", "A naturally radiant, healthy-looking glow", "Better support for a healthy moisture barrier"],
    closing: "Glow Naturally. Nourish Deeply. Shine Every Day. Care Inspired by Nature. Wellness for Every Skin."
  },
  {
    id: "hair-scalp",
    ...
    suitableFor: ["Dry scalp", "Dry or brittle hair", "Natural hair", "Curly and coily hair", "Braids and twists", "Locs", "Chemically treated hair", "Colour-treated hair", "Protective styles"],
    results: ["Better moisturized hair and scalp", "Softer, more manageable hair", "More comfort with less dryness", "Shinier, healthier-looking hair", "A cleaner, healthier-feeling scalp environment"],
    closing: "Healthy Scalp. Nourished Hair. Naturally Beautiful. Care Inspired by Nature. Wellness for Every Hair Type."
  },
  {
    id: "spa-essentials",
    ...
    suitableFor: ["Homes", "Offices", "Bedrooms and living rooms", "Beauty salons and barber shops", "Spas and hotels", "Wellness centres", "Yoga and meditation studios", "Reception areas", "Gift hampers and wellness packages"],
    ...
    closing: "Breathe Deeply. Relax Naturally. Restore Your Mind, Body & Home. Care Inspired by Nature. Wellness Beyond Skincare."
  }
];
      ...
      {guides.map((guide, index) => (
        <article className="wellness-guide" id={guide.id} key={guide.id}>
          ...
          <div className="guide-routine-grid">
            ...
            {guide.suitableFor ? <section><span>Suitable for</span><ul>{guide.suitableFor.map((item) => <li key={item}><CheckCircle2 size={15} />{item}</li>)}</ul></section> : null}
            <section><span>With consistent use</span><ul>{guide.results.map((item) => <li key={item}><CheckCircle2 size={15} />{item}</li>)}</ul></section>
          </div>
          {guide.closing ? <blockquote className="guide-closing">{guide.closing}</blockquote> : null}
        </article>
      ))}
